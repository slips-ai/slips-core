...
type Task struct {
	...
	StartDateKind string                 `protobuf:"bytes,8,opt,name=start_date_kind,json=startDateKind,proto3" json:"start_date_kind,omitempty"` // "inbox" or "specific_date"
	StartDate     *string                `protobuf:"bytes,9,opt,name=start_date,json=startDate,proto3,oneof" json:"start_date,omitempty"`         // format "YYYY-MM-DD", only set when start_date_kind is "specific_date"
...
func (x *Task) GetStartDateKind() string {
	if x != nil {
		return x.StartDateKind
	}
	return ""
}
...
type CreateTaskRequest struct {
	...
	StartDateKind *string                `protobuf:"bytes,4,opt,name=start_date_kind,json=startDateKind,proto3,oneof" json:"start_date_kind,omitempty"` // optional, defaults to "inbox"
	StartDate     *string                `protobuf:"bytes,5,opt,name=start_date,json=startDate,proto3,oneof" json:"start_date,omitempty"`               // optional, only needed when start_date_kind is "specific_date"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateTaskRequest) GetStartDateKind() string {
	if x != nil && x.StartDateKind != nil {
		return *x.StartDateKind
	}
	return ""
}
...
type UpdateTaskRequest struct {
	...
	StartDateKind *string                `protobuf:"bytes,5,opt,name=start_date_kind,json=startDateKind,proto3,oneof" json:"start_date_kind,omitempty"` // optional
...
func (x *UpdateTaskRequest) GetStartDateKind() string {
	if x != nil && x.StartDateKind != nil {
		return *x.StartDateKind
	}
	return ""
...
const file_task_v1_task_proto_rawDesc = "" +
	"\n" +
	"\x12task/v1/task.proto\x12\atask.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfe\x02\n" +
	"\x04Task\x12\x0e\n" +
	...
	"\x0fstart_date_kind\x18\b \x01(\tR\rstartDateKind\x12\"\n" +
	"\n" +
	"start_date\x18\t \x01(\tH\x01R\tstartDate\x88\x01\x01B\x0e\n" +
	"\f_archived_atB\r\n" +
	"\v_start_date\"\xd0\x01\n" +
	"\x11CreateTaskRequest\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x14\n" +
	"\x05notes\x18\x02 \x01(\tR\x05notes\x12\x1b\n" +
	"\ttag_names\x18\x03 \x03(\tR\btagNames\x12+\n" +
	"\x0fstart_date_kind\x18\x04 \x01(\tH\x00R\rstartDateKind\x88\x01\x01\x12\"\n" +
	"\n" +
	"start_date\x18\x05 \x01(\tH\x01R\tstartDate\x88\x01\x01B\x12\n" +
	"\x10_start_date_kindB\r\n" +
	"\v_start_date\"7\n" +
	...
	"\x04task\x18\x01 \x01(\v2\r.task.v1.TaskR\x04task\"\xe0\x01\n" +
	"\x11UpdateTaskRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x14\n" +
	"\x05notes\x18\x03 \x01(\tR\x05notes\x12\x1b\n" +
	"\ttag_names\x18\x04 \x03(\tR\btagNames\x12+\n" +
	"\x0fstart_date_kind\x18\x05 \x01(\tH\x00R\rstartDateKind\x88\x01\x01\x12\"\n" +
	"\n" +
	"start_date\x18\x06 \x01(\tH\x01R\tstartDate\x88\x01\x01B\x12\n" +
	"\x10_start_date_kindB\r\n" +
	"\v_start_date\"7\n" +
