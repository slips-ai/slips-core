...
const file_proto_tag_v1_tag_proto_rawDesc = "" +
	"\n" +
	"\x16proto/tag/v1/tag.proto\x12\x06tag.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9f\x01\n" +
	"\x03Tag\x12\x0e\n" +
	...
	"\bListTags\x12\x17.tag.v1.ListTagsRequest\x1a\x18.tag.v1.ListTagsResponseB\x8a\x01\n" +
	"\n" +
	"com.tag.v1B\bTagProtoP\x01Z9github.com/slips-ai/slips-core/gen/api/proto/tag/v1;tagv1\xa2\x02\x03TXX\xaa\x02\x06Tag.V1\xca\x02\x06Tag\\V1\xe2\x02\x12Tag\\V1\\GPBMetadata\xea\x02\aTag::V1b\x06proto3"

var (
	file_proto_tag_v1_tag_proto_rawDescOnce sync.Once
	file_proto_tag_v1_tag_proto_rawDescData []byte
)

func file_proto_tag_v1_tag_proto_rawDescGZIP() []byte {
	file_proto_tag_v1_tag_proto_rawDescOnce.Do(func() {
		file_proto_tag_v1_tag_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_tag_v1_tag_proto_rawDesc), len(file_proto_tag_v1_tag_proto_rawDesc)))
	})
	return file_proto_tag_v1_tag_proto_rawDescData
}

var file_proto_tag_v1_tag_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_tag_v1_tag_proto_goTypes = []any{
...
func file_proto_tag_v1_tag_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_tag_v1_tag_proto_rawDesc), len(file_proto_tag_v1_tag_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
